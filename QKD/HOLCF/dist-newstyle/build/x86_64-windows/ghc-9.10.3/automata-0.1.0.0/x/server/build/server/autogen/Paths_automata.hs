...
-- at runtime using the environment variable automata_bindir.
...
-- environment variable automata_libdir.
...
-- using the environment variable automata_dynlibdir.
...
-- runtime using the environment variable automata_datadir.
...
-- using the environment variable automata_sysconfdir.
...
libdir     = "D:\\Haskell\\cabal\\x86_64-windows-ghc-9.10.3-b42a\\automata-0.1.0.0-inplace-server"
dynlibdir  = "D:\\Haskell\\cabal\\x86_64-windows-ghc-9.10.3-b42a"
datadir    = "D:\\Haskell\\cabal\\x86_64-windows-ghc-9.10.3-b42a\\automata-0.1.0.0"
libexecdir = "D:\\Haskell\\cabal\\automata-0.1.0.0-inplace-server\\x86_64-windows-ghc-9.10.3-b42a\\automata-0.1.0.0"
